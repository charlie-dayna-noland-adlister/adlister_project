<%@ page import="com.codeup.adlister.models.Review" %>
...
<%--        <jsp:useBean id = "test" class = "com.codeup.adlister.models.Ad" />--%>
<%--        <p>Got message....</p>--%>
...
<%--                        <small class="text-light">${ad.reviewsList}</small>--%>
<%--                        <c:forEach var="review" items="${ad.reviewsList}">--%>
<%--                            <small class="text-light">Review Text${review.reviewText}</small>--%>
<%--                            <small class="text-light">Review Text${review.rating}</small>--%>
<%--                        </c:forEach>--%>
                    </div>
                    ...
                    <div class="text-center mb-2">
                        <button type="button" class="learn-btn py-0 mb-2" data-toggle="modal"
                                data-target="#ad-modal-${ad.id}">Learn more</button>
                    </div>
                    <!-- Modal -->
                        <%--                <c:forEach var="ad" items="${ads}">--%>
                    <div class="modal fade" id="ad-modal-${ad.id}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                                ...
                                <div class="modal-body p-0">
                                    <div class="row">
                                        ...
                                        <div class="col pl-0 d-flex flex-column justify-content-center align-items-center">
                                            ...
                                            <button type="button" class="delete-button py-0 mb-2" id="delete-${ad.id}">
                                                Delete Ad
                                            </button>
                                        </div>
                                    </div>
